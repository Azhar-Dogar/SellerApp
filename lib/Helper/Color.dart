...
const Color primary = Color(0xff35938D);
const Color secondary = Color(0xffF7B501);
const Color newPrimary = Color(0xff008080);
const Color fontColor = Color(0xff4543C1);
const Color grad1Color = Color(0xff549D70);
const Color grad2Color = Color(0xff008080);
